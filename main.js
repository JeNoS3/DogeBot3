...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    DogeXeonOP.sendMessage(`967772535900@s.whatsapp.net`, `Bot Jenos`, MessageType.extendedText)
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "BoT JeNoS", "conversation")
      }
      ...
      welcomeBut = [{buttonId:`#menu`,buttonText:{displayText:'القائمة'},type:1}, {buttonId:`#getdesc`,buttonText:{displayText:'READ DESC 📋'},type:1}]
      ...
      goodbyeBut = [{buttonId:`#gbye`,buttonText:{displayText:'BYE 👋'},type:1}, {buttonId:`#menu`,buttonText:{displayText:'القائمة'}, type:1}]
